...
import com.sanshang.li.mybaseframwork.floatwindow.view.menu.runner.ICarrier;
import com.sanshang.li.mybaseframwork.floatwindow.view.menu.runner.ScrollRunner;
...
public class MenuLayout extends ViewGroup implements ICarrier {
    ...
    public MenuLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        MIN_RADIUS = DeviceUtils.dp2px(context, 65);
