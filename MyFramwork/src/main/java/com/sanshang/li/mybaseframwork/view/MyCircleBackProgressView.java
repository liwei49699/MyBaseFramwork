...
public class MyCircleBackProgressView extends View {
    ...
    public MyCircleBackProgressView(Context context) {
        this(context, null);
    }

    public MyCircleBackProgressView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyCircleBackProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     * @return
     */
    public MyCircleBackProgressView setProgressListener(ProgressListener listener) {
        progressListener = listener;
        return this;
    }

    public MyCircleBackProgressView setProgress(float progress) {
        mProgress = progress;
        initAnimation();
        return this;
    }
