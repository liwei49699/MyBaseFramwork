...
import com.sanshang.li.mybaseframwork.systemfloat.util.MotionVelocityUtils;
import com.sanshang.li.mybaseframwork.systemfloat.util.Util;
import com.sanshang.li.mybaseframwork.systemfloat.view.runner.ICarrier;
import com.sanshang.li.mybaseframwork.systemfloat.view.runner.OnceRunnable;
import com.sanshang.li.mybaseframwork.systemfloat.view.runner.ScrollRunner;
...
public class FloatBall extends FrameLayout implements ICarrier {
    ...
    private MotionVelocityUtils mVelocity;
    /**
     * 处于未操作状态
     */
    ...
    private void init(Context context) {
        ...
        mVelocity = new MotionVelocityUtils(context);
    }

    private void initLayoutParams(Context context) {
        mLayoutParams = FloatBallUtils.getLayoutParams(context);
    }
