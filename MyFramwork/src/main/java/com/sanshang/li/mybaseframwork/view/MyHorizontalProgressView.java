...
public class MyHorizontalProgressView extends View {
     ...
     * @return
     */
    public MyHorizontalProgressView setProgressWithAnimation(float progress) {
     ...
     * @return
     */
    public MyHorizontalProgressView setCurrentProgress(float progress) {
     ...
     * @return
     */
    public MyHorizontalProgressView setProgressListener(ProgressListener listener) {
